            ...
            steps {
                script {
                    ...
                    //withCredentials([Skipdetection(credentialsId: 'hrb', xxVariable: 'xx', xxVariable: 'xx')]) {           
                        ...
                        docker build -t product/${env.ServiceName}:${env.VERSION} . //Use the version number generated by the setup step to name the tag of docker image.
                        //docker tag xxx/${env.ServiceName}:${env.VERSION} hrb/xxx/${env.ServiceName}:${env.VERSION}
